...
## Red brand edition — September 13, 2026

The user's red phone image informed the new curved-A geometry; the supplied Allowance mockup informed the palette and editorial layout. The 26 downloadable compositions are original vector layouts generated from the canonical symbol. The reference phone photograph and external template films are not included in the application or kit. No generated composition claims actual paid activity or verified settlement.
