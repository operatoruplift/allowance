...
The supplied Allowance mockup informed the palette and editorial layout. The canonical symbol is the original open-bottom boundary-and-dot geometry (`M7 23V7H25V23`, dot centered at `(16,21)`). The 26 downloadable compositions are original vector layouts generated from that symbol. No generated composition claims actual paid activity or verified settlement.
