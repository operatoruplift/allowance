...
| Public comparison | Vercel deployment `dpl_AHkuAUhTqPcLJfJXshWCG1LWfRLs` | Public parity with candidate after explicit deployment request | Read-only route checks, asset hashes, public hosted browser suite and recovery fixture | **Verified for static rehearsal** |
